...
int CheckObjects(t_line *l)
{
	...
	if (!isnan(res.res) && res.res < 200000000)
...
void CheckObjects2(t_line *l, t_obj *o, t_result *res)
{
	...
	if (o->type == 1 && foo() && !isnan(tmp = CheckSphere(l, o->obj))
